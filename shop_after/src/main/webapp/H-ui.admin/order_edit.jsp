...
<link
	href="${ pageContext.request.contextPath }/H-ui.admin/lib/webuploader/0.1.5/webuploader.css"
...
<body>
	...
	修改商品 <a class="btn btn-success radius r"
		style="line-height: 1.6em; margin-top: 3px"
		href="javascript:location.replace(location.href);" title="刷新"><i
		class="Hui-iconfont">&#xe68f;</i></a></nav>
	<s:form theme="simple" action="mdse_editMdse" method="post"
		class="form form-horizontal" id="form-article-add"
		enctype="multipart/form-data" namespace="/"   style="margin-left: 25%; margin-top: 3%;">
		<s:hidden name="mdse_id" value="%{mdse_id}" />
		<div class="page-container" >
			<input type="hidden" name="user.user_id"
				value="<s:property value="user.user_id"/>" />
			<s:hidden name="mdse_status" value="2" />
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">商品名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<s:textfield type="text" cssClass="input-text" value="%{mdse_name}"
						name="mdse_name" cssStyle="width: 300px" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">商品价格：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<s:textfield type="text" cssClass="input-text"
						value="%{mdse_price}" name="mdse_price" cssStyle="width: 300px" />
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<s:textfield type="text" cssClass="input-text"
						value="%{mdse_quantity}" name="mdse_quantity"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-6 col-sm-4">
					<s:textarea name="mdse_mome" rows="5" cols="45"></s:textarea>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">商品图片：</label> 
<%-- 				<img alt="" src="<s:property value="mdse_imge"/>" name="mdse_imge">
 --%>				<input type="file" name="upload">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<s:submit class="btn btn-primary radius" value="提交"></s:submit>
				<a href="${ pageContext.request.contextPath }/mdse_findAll.action"
					class="btn btn-default radius" onClick="layer_close();">&nbsp;&nbsp;取消&nbsp;&nbsp;</a>
			</div>
		</div>
	...
	<script type="text/javascript"
		src="${ pageContext.request.contextPath }/H-ui.admin/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
	<script type="text/javascript"
		src="${ pageContext.request.contextPath }/H-ui.admin/lib/jquery.validation/1.14.0/validate-methods.js"></script>
	<script type="text/javascript"
		src="${ pageContext.request.contextPath }/H-ui.admin/lib/jquery.validation/1.14.0/messages_zh.js"></script>
	<script type="text/javascript"
		src="${ pageContext.request.contextPath }/H-ui.admin/lib/webuploader/0.1.5/webuploader.min.js"></script>
	<script type="text/javascript"
		src="${ pageContext.request.contextPath }/H-ui.admin/lib/ueditor/1.4.3/ueditor.config.js"></script>
	<script type="text/javascript"
		src="${ pageContext.request.contextPath }/H-ui.admin/lib/ueditor/1.4.3/ueditor.all.min.js">
		
	</script>
	<script type="text/javascript"
		src="${ pageContext.request.contextPath }/H-ui.admin/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
	<script type="text/javascript">
		$(function() {
