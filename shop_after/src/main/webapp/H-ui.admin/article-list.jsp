...
<form action="<%=request.getContextPath() %>/zixun_select.do" method="post">
	<div class="text-c">
	 ...
	 <span class="select-box inline">
		...
		<input type="text" name="select" id="" placeholder=" 资讯名称" style="width:250px" class="input-text">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<c:forEach items="${list}" var="store" varStatus="st">
				<tr class="text-c">
					...
					<td>${store.id}</td>
					<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10002')" title="查看">${store.articletitle}</u></td>
					...
					<a style="text-decoration:none" class="ml-5"  href="zixun_updateName.do?id=${store.id }" title="编辑">
					<i class="Hui-iconfont">&#xe6df;</i></a> 
					<a style="text-decoration:none" class="ml-5"  href="zixun_delete.do?id=${store.id }" title="删除" >
					<i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
