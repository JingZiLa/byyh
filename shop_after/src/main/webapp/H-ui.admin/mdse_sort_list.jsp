...
<script type="text/javascript">
	$(function() {
		$('.sort_addtime').datepick({
			dateFormat : 'yy-mm-dd'
		});
		$('.sort_end_time').datepick({
			dateFormat : 'yy-mm-dd'
		});
	});
</script>
...
<body>
	...
	分类列表 <a class="btn btn-success radius r"
		style="line-height: 1.6em; margin-top: 3px"
		href="javascript:location.replace(location.href);" title="刷新"><i
		class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="page-container">
		<form action="${pageContext.request.contextPath }/sort_findAll.action"
			method="post" id="forms">
			<div class="text-c">
				分类名称： <input type="text" name="sort_name" id="" placeholder="分类名称"
					style="width: 250px" class="input-text"
					value="<s:property value="sort_name"/>"> 添加时间： <input
					type="text"
					onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'logmax\')||\'%y-%M-%d\'}' })"
					id="logmax" class="input-text Wdate sort_addtime"
					style="width: 120px;" name="sort_addtime"
					value="<s:date name='sort_addtime' format="yyyy-MM-dd"/>" /> 到 <input
					type="text"
					onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'logmin\')}',maxDate:'%y-%M-%d' })"
					id="logmax" class="input-text Wdate sort_end_time"
					style="width: 120px;" name="sort_end_time"
					value="<s:date name='sort_end_time' format="yyyy-MM-dd"/>">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l"><a href="javascript:;" onclick="datadel()"
					...
					href="${ pageContext.request.contextPath }/sort_saveUI.action">
						<i class="Hui-iconfont">&#xe600;</i> 添加分类
				</a></span> <span class="r">共有分类：<strong><s:property
							value="totalCount" /></strong>类
				</span>
			</div>
			<div class="mt-20">
				<table
					...
					<thead>
						<tr class="text-c">
							...
							<th width="100">分类添加时间</th>
							<th width="100">分类添加人</th>
							<th width="100">分类商品状态</th>
							<th width="100">操作</th>
						</tr>
					</thead>
					<tbody>
						<tr class="text-c">
							<s:iterator value="list">
								<tr class="text-c">
									<td><input name="sort_id" type="checkbox" value="sort_id"></td>
									<td><s:property value="sort_id" /></td>
									<td><s:property value="sort_name" /></td>
									<td><s:date name="sort_addtime" format="yyyy-MM-dd" /></td>
									<td><s:property value="user.user_name" /></td>
									<td class="td-status"><span
										class="label label-success radius">上架中</span></td>

									<td class="td-manage"><a style="text-decoration: none"
										onClick="picture_stop(this,<s:property value="mdse_id" />)"
										href="javascript:;" title="下架"> <i class="Hui-iconfont">&#xe6de;</i></a>
										<a style="text-decoration: none" class="ml-5"
										href="${ pageContext.request.contextPath }/sort_deleteSort.action?sort_id=<s:property value="sort_id" />"
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l" style="margin-left: 55%;"> <span class="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;共有分类：<strong><s:property
