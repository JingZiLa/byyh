...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<%=request.getContextPath() %>/img_add.do" method="post" enctype="multipart/form-data">
		<div class="row cl">
