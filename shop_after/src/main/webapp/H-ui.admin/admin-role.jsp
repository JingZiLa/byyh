...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" href="<%=request.getContextPath() %>/admin_updatename.do" onclick="admin_role_add('添加角色','admin-role-add.jsp','800')"><i class="Hui-iconfont">&#xe600;</i> 增加角色或修改角色</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>${store.id }</td>
				<td>${store.adminRole }</td>
				<td><a href="#">${store.username }</a></td>
				<td>${store.adminAs }</td>
