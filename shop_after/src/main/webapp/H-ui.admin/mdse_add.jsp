...
<body>
	...
	添加商品 <a class="btn btn-success radius r"
		style="line-height: 1.6em; margin-top: 3px"
		href="javascript:location.replace(location.href);" title="刷新"><i
		class="Hui-iconfont">&#xe68f;</i></a></nav>
	<form action="${ pageContext.request.contextPath }/mdse_saveMdse.action"
		method="post" class="form form-horizontal" id="form-article-add"
		enctype="multipart/form-data" style="margin-left: 25%; margin-top: 3%;">
		<div class="page-container">
			<input type="hidden" name="mdse.user.user_id" value="<s:property value="#session.existUser.user_id"/>"/>
			<s:hidden name="mdse_status" value="2"/>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">商品名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value=""
						placeholder="请输入商品名称" id="" name="mdse_name" style="width: 300px">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value=""
						placeholder="请输入商品名称" id="" name="mdse_price" style="width: 300px">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value=""
						placeholder="请输入商品名称" id="" name="mdse_quantity" style="width: 300px">
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-6 col-sm-4">
					<textarea name="mdse_mome" cols="" rows="" class="textarea"
						placeholder="请具体描述商品信息：最少输入10个字符" datatype="*10-100"
						dragonfly="true" nullmsg="商品详情不能为空！"
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">商品图片：</label> <input
