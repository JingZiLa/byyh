...
<body>
	...
	订单详情 <span class="c-gray en">&gt;</span>订单商品详情<a
	...
	<div class="page-container">
			...
			<table class="table table-border table-bordered table-hover " style="margin-top: 30px;">
				...
				<thead>
					...
					<tr class="text-c">
						...
						<td><s:property value="mdse.mdse_user_id" /></td>
		...
		style="line-height: 1.6em; margin-top: 3px"
		href="${ pageContext.request.contextPath }/order_deleteOrder.action?order_id=<s:property value="order_id" />" title="删除订单">删除订单</a></nav>
		</div>
	</div>
