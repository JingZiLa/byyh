...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<%=request.getContextPath() %>/article_add.do" method="post">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<input id="editor" type="text/plain" style="width:100%;height:400px;" name="content"></input> 
			</div>
		</div>
		<div class="row cl">
