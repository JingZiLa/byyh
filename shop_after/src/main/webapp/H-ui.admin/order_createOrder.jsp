...
<body>
	...
	创建订单(测试) <a class="btn btn-success radius r"
		style="line-height: 1.6em; margin-top: 3px"
		href="javascript:location.replace(location.href);" title="刷新"><i
		class="Hui-iconfont">&#xe68f;</i></a></nav>
	<s:form theme="simple" action="order_createOrder" method="post"
		...
		<div class="page-container" >
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">添加订单商品：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<table>
					<s:iterator value="list">
						<tr>
							<input name="mdses_id" type="checkbox" value='<s:property value="mdse_id"/>'>
							<s:property value="mdse_name"/>
						</tr>
						</s:iterator>
						<tr>
							<s:submit value="创建订单"></s:submit>
						</tr>
