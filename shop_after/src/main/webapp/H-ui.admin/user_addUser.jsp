...
<div class="pd-20">
  ...
  <nav class="breadcrumb">
    ...
    <form action="${ pageContext.request.contextPath }/user_addUser.action" method="post" style="margin-left: 25%; margin-top: 3%;" enctype="multipart/form-data">
      <table class="table table-bg">
        <tbody>
        <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> 用户账号：</th>
            <td><input type="text" style="width:200px" class="input-text" value="" placeholder="" id="user-name" name="user_code" datatype="*2-16" nullmsg="用户账号不能为空"></td>
          </tr>
          <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> 用户密码：</th>
            <td><input type="text" style="width:200px" class="input-text" value="" placeholder="" id="user-name" name="user_password" datatype="*2-16" nullmsg="用户密码不能为空"></td>
          </tr>
          <tr>
            <th width="100" class="text-r"><span class="c-red">*</span> 用户名：</th>
            <td><input type="text" style="width:200px" class="input-text" value="" placeholder="" id="user-name" name="user_name" datatype="*2-16" nullmsg="请输入用户名"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" style="width:300px" class="input-text" value="" placeholder="" id="user-tel" name="user_phone"></td>
          </tr>
          <tr>
            <th class="text-r">邮箱：</th>
            <td><input type="text" style="width:300px" class="input-text" value="" placeholder="" id="user-email" name="user_email"></td>
          </tr>
          <tr>
            <th class="text-r">用户头像：</th>
            <td><input type="file" class="" name="upload" multiple >
            </td>
          </tr>
          <tr>
            ...
            <input type="text" style="width:300px" class="input-text" value="" placeholder="详细地址:" id="user-address" name="user_address"></td>
          </tr>
          <tr>
            <th class="text-r">简介：</th>
            <td><textarea class="input-text" name="user_info" id="user-info" style="height:100px;width:300px;"></textarea></td>
          </tr>
          <tr>
            <th></th>
