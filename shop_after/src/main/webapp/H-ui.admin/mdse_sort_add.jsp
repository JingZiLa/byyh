...
<body>
	...
	添加商品分类 <a class="btn btn-success radius r"
		style="line-height: 1.6em; margin-top: 3px"
		href="javascript:location.replace(location.href);" title="刷新"><i
		class="Hui-iconfont">&#xe68f;</i></a></nav>
	<form action="${ pageContext.request.contextPath }/sort_saveMdse.action"
		...
		<div class="page-container">
			<input type="hidden" name="sort.user.user_id" value="<s:property value="#session.existUser.user_id"/>"/>
			<s:hidden name="sort_status" value="2"/>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">分类名称：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value=""
						placeholder="请输入分类名称" id="" name="sort_name" style="width: 300px">
				</div>
			</div>
