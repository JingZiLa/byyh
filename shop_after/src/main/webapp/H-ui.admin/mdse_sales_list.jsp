...
<body>
	...
	促销商品 <a class="btn btn-success radius r"
						...
						<tr class="text-c"  >
							<s:iterator value="list">
								<tr class="text-c">
									...
									<td width="150">
									<img width="130" height="100" class="picture-thumb"
									...
									<td class="td-status"><span
										class="label label-success radius">促销中</span></td>
									...
									<td class="td-manage"><a style="text-decoration: none"
										...
										title="停止促销"> <i class="Hui-iconfont">&#xe6de;</i></a> 
								</tr>
							</s:iterator>
					</tbody>
	...
	function to_page(page) {
		...
		function picture_stop(obj, id) {
			layer.confirm('确认要停止促销该商品吗？',
							function(index) {
								var url = "${pageContext.request.contextPath }/mdse_SalesMdse.action?mdse_id="+id;
									$.ajax({
							            type: "post",
							            url: url,
							            data: null,
